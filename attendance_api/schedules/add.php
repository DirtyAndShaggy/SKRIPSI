...
// Check for overlapping schedule (same class, same group, same day, overlapping time)
$checkQuery = "
...
$query = "INSERT INTO class_schedules (class_id, group_id, room_id, day_of_week, start_time, end_time, device_id, semester, grace_period) 
          VALUES ('$class_id', $group_value, $room_value, '$day_of_week', '$start_time', '$end_time', '$device_id', $semester_value, $grace_period_value)";
